...
<div class="fixed top-1/4 right-[10%] text-secondary-fixed/30 pointer-events-none">
    <span class="material-symbols-outlined text-[48px]" style="font-variation-settings: 'FILL' 1;">auto_awesome</span>
</div>
<div class="fixed bottom-1/4 left-[8%] text-primary/20 pointer-events-none">
    <span class="material-symbols-outlined text-[80px]" style="font-variation-settings: 'FILL' 1;">star</span>
</div>
...
<div class="flex-1 flex items-center justify-center px-gutter pt-xl pb-lg">
    <div class="glass-card rounded-lg p-md w-full max-w-sm flex flex-col gap-md">
        <div class="text-center flex flex-col gap-xs">
            <h1 class="font-display-lg-mobile text-display-lg-mobile text-primary font-bold">Buat Akun</h1>
            <p class="font-body-md text-body-md text-on-surface-variant">Bergabung dan nikmati pengalaman konser bersama LUNA.</p>
        </div>

        <form action="../backend/proses_register.php" method="POST" class="flex flex-col gap-sm"> <!-- GANTI PATH -->
            <div class="flex flex-col gap-xs">
                <label class="font-label-sm text-label-sm text-on-surface-variant">Username</label>
        ...
        <p class="text-center font-body-md text-body-md text-on-surface-variant">
            Sudah punya akun?
            <a href="login.php" class="text-primary hover:underline">Masuk di sini</a> <!-- GANTI PATH -->
        </p>
    </div>
</div>
